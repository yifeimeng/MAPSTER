...
void constructSupercell(FILE *fpCell, float *atomSupercell, expPara *para, sfInfo *info);
...
void calculatePhaseGrating(float *atomSupercell, expPara *para, sfInfo *info);
